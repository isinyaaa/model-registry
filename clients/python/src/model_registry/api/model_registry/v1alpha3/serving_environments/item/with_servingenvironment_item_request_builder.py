...
class WithServingenvironmentItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: Optional[BaseResourceUpdate] = None, request_configuration: Optional[RequestConfiguration] = None) -> Optional[ServingEnvironment]:
        """
    ...
    def to_patch_request_information(self,body: Optional[BaseResourceUpdate] = None, request_configuration: Optional[RequestConfiguration] = None) -> RequestInformation:
        """
        Updates an existing `ServingEnvironment`.
        param body: A Model Serving environment for serving `RegisteredModels`.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
