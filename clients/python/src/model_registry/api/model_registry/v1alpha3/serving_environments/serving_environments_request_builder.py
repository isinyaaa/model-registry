...
if TYPE_CHECKING:
    ...
    from .item.with_servingenvironment_item_request_builder import (
        WithServingenvironmentItemRequestBuilder,
    )
...
class Serving_environmentsRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: str | dict[str, Any]) -> None:
        ...
        Returns: None.
        """
        super().__init__(request_adapter, "{+baseurl}/api/model_registry/v1alpha3/serving_environments{?nextPageToken*,orderBy*,pageSize*,sortOrder*}", path_parameters)
    ...
    def by_servingenvironment_id(self,servingenvironment_id: str) -> WithServingenvironmentItemRequestBuilder:
        ...
        if not servingenvironment_id:
            msg = "servingenvironment_id cannot be null."
            raise TypeError(msg)
        from .item.with_servingenvironment_item_request_builder import (
            WithServingenvironmentItemRequestBuilder,
        )
    ...
    async def post(self,body: ServingEnvironmentCreate | None = None, request_configuration: RequestConfiguration | None = None) -> ServingEnvironment | None:
    ...
    def to_post_request_information(self,body: ServingEnvironmentCreate | None = None, request_configuration: RequestConfiguration | None = None) -> RequestInformation:
        """Creates a new instance of a `ServingEnvironment`.
        param body: A Model Serving environment for serving `RegisteredModels`.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation.
        ...
        if not body:
            msg = "body cannot be null."
            raise TypeError(msg)
        request_info = RequestInformation(Method.POST, "{+baseurl}/api/model_registry/v1alpha3/serving_environments", self.path_parameters)
        request_info.configure(request_configuration)
        request_info.headers.try_add("Accept", "application/json")
        request_info.set_content_from_parsable(self.request_adapter, "application/json", body)
        return request_info

    def with_url(self,raw_url: str | None = None) -> Serving_environmentsRequestBuilder:
