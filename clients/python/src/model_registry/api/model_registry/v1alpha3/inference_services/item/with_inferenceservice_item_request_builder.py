...
class WithInferenceserviceItemRequestBuilder(BaseRequestBuilder):
    ...
    async def patch(self,body: InferenceServiceUpdate | None = None, request_configuration: RequestConfiguration | None = None) -> InferenceService | None:
    ...
    def to_patch_request_information(self,body: InferenceServiceUpdate | None = None, request_configuration: RequestConfiguration | None = None) -> RequestInformation:
        """Updates an existing `InferenceService`.
        param body: An `InferenceService` entity in a `ServingEnvironment` represents a deployed `ModelVersion` from a `RegisteredModel` created by Model Serving.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation.
    ...
    def with_url(self,raw_url: str | None = None) -> WithInferenceserviceItemRequestBuilder:
