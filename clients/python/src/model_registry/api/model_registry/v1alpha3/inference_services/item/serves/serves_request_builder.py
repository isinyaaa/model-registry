...
class ServesRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: ServeModelCreate | None = None, request_configuration: RequestConfiguration | None = None) -> ServeModel | None:
    ...
    def to_post_request_information(self,body: ServeModelCreate | None = None, request_configuration: RequestConfiguration | None = None) -> RequestInformation:
        """Creates a new instance of a `ServeModel` associated with `InferenceService`.
        param body: An ML model serving action.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation.
    ...
    def with_url(self,raw_url: str | None = None) -> ServesRequestBuilder:
