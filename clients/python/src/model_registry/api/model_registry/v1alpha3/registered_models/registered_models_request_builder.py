...
if TYPE_CHECKING:
    ...
    from .item.with_registeredmodel_item_request_builder import (
        WithRegisteredmodelItemRequestBuilder,
    )
...
class Registered_modelsRequestBuilder(BaseRequestBuilder):
    ...
    def by_registeredmodel_id(self,registeredmodel_id: str) -> WithRegisteredmodelItemRequestBuilder:
        ...
        if not registeredmodel_id:
            msg = "registeredmodel_id cannot be null."
            raise TypeError(msg)
        from .item.with_registeredmodel_item_request_builder import (
            WithRegisteredmodelItemRequestBuilder,
        )
    ...
    async def post(self,body: RegisteredModelCreate | None = None, request_configuration: RequestConfiguration | None = None) -> RegisteredModel | None:
    ...
    def to_post_request_information(self,body: RegisteredModelCreate | None = None, request_configuration: RequestConfiguration | None = None) -> RequestInformation:
        """Creates a new instance of a `RegisteredModel`.
        param body: A registered model in model registry. A registered model has ModelVersion children.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation.
    ...
    def with_url(self,raw_url: str | None = None) -> Registered_modelsRequestBuilder:
