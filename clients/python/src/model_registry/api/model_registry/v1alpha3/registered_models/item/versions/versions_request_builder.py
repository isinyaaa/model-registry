...
class VersionsRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: ModelVersion | None = None, request_configuration: RequestConfiguration | None = None) -> ModelVersion | None:
    ...
    def to_post_request_information(self,body: ModelVersion | None = None, request_configuration: RequestConfiguration | None = None) -> RequestInformation:
        """Creates a new instance of a `ModelVersion`.
        param body: Represents a ModelVersion belonging to a RegisteredModel.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation.
    ...
    def with_url(self,raw_url: str | None = None) -> VersionsRequestBuilder:
