...
if TYPE_CHECKING:
    ...
    from .item.with_modelversion_item_request_builder import (
        WithModelversionItemRequestBuilder,
    )
...
class Model_versionsRequestBuilder(BaseRequestBuilder):
    ...
    def by_modelversion_id(self,modelversion_id: str) -> WithModelversionItemRequestBuilder:
        ...
        if not modelversion_id:
            msg = "modelversion_id cannot be null."
            raise TypeError(msg)
        from .item.with_modelversion_item_request_builder import (
            WithModelversionItemRequestBuilder,
        )
    ...
    async def post(self,body: ModelVersionCreate | None = None, request_configuration: RequestConfiguration | None = None) -> ModelVersion | None:
    ...
    def to_post_request_information(self,body: ModelVersionCreate | None = None, request_configuration: RequestConfiguration | None = None) -> RequestInformation:
        """Creates a new instance of a `ModelVersion`.
        param body: Represents a ModelVersion belonging to a RegisteredModel.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation.
    ...
    def with_url(self,raw_url: str | None = None) -> Model_versionsRequestBuilder:
